...
// Set string compression to true or false
angularLocalStorage.value('compress', true);
...
angularLocalStorage.service('localStorageService', [
  ...
  'LZString',
  'compress',
  function($rootScope, prefix, cookie, notify, LZString, compress) {
  ...
  var addToLocalStorage = function (key, value) {
    ...
    try {
      ...
      console.log('value before adding/compression', value);
      //compressing if compress is set to true
      if(compress){ value = LZString.compress(value) }
  ...
  console.log('item before decompression: ', item);
  if(compress){ console.log('about to decompress', compress); item = LZString.decompress(item); }
  console.log('item after decompression: ', item);
...
angular.module('LocalStorageModule').factory('LZString',[function() {
